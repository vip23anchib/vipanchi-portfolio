...
export default function AboutSection() {
  return (
    <section id="about" className="py-16 md:py-20 bg-[#FAF8F4]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0, transition: { duration: 0.65, ease: [0.16, 1, 0.3, 1], delay: 0.1 } } }}
            ...
            <div className="lg:col-span-7 space-y-4">
              <div className="p-6 sm:p-7 rounded-2xl bg-white border border-[#DDD6C9] shadow-sm hover:shadow-md transition-all duration-300 space-y-4">
                ...
                <p className="text-[#374151] text-sm sm:text-base leading-relaxed">
                  ...
                  <strong className="text-[#111827]">Saurabhi Media</strong>, I built B2B SaaS backend infrastructures, designed 15+ secure RESTful endpoints with RBAC, engineered watch-folder ETL daemons, and integrated speech-to-text diarization pipelines using Whisper &amp; PyAnnote.
                </p>
              ...
              <div className="p-6 sm:p-7 rounded-2xl bg-white border border-[#DDD6C9] shadow-sm hover:shadow-md transition-all duration-300 space-y-5">
                <div className="flex items-start justify-between gap-3 pb-3 border-b border-[#EAE4D9]">
                  <div className="flex items-center gap-3">
                    <div className="w-11 h-11 rounded-xl bg-metro-backend/10 text-metro-backend flex items-center justify-center">
                      <GraduationCap className="w-6 h-6" />
                    </div>
                    <div>
                      <h3 className="font-black text-[#111827] text-base sm:text-lg">{portfolioData.education.institution}</h3>
                      <p className="text-xs text-[#6B7280] mt-0.5">{portfolioData.education.degree} in {portfolioData.education.major}</p>
                    </div>
                  </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                    {portfolioData.education.coursework.map((course, idx) => (
                      <div key={idx} className="p-2.5 rounded-xl bg-[#FAF8F4] border border-[#DDD6C9] text-xs font-semibold text-[#374151] flex items-center gap-2 hover:bg-white hover:border-metro-backend/50 transition-all">
